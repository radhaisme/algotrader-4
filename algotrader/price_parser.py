...
class PriceParser(object):
    ...
    within the trading platform. Due to efficiency and floating point precision limitations,
    Algotrader uses an integer to represent all prices. This means that $0.10 is,
