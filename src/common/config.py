...
class OandaContext():
    """
    Context object of V20 Oanda engine
    """
    ...
    def create_streaming_context(self):
        ...
        try:
            ...
            print('There is a problem with the creation of the Oanda Streaming API context.')
...
class SqlEngine():
    ...
    def create_engine(self):
        """
        Inicialize engine to MySQL database for a given configuration 
        """
        ...
        try:
            ...
            print('There is a problem with the engine creation - Check configuration or server')
